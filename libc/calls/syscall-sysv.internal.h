...
i32 sys_close(i32);
i32 sys_epoll_create1(i32);
i32 sys_epoll_ctl(i32, i32, i32, void *);
i32 sys_epoll_pwait(i32, void *, i32, i32, const void *, u64);
i32 sys_kqueue(void);
i32 sys_kevent(i32, const void *, i32, void *, i32, const void *);
i32 sys_close_range(u32, u32, u32);
i32 sys_fallocate(i32, i32, i64, i64);
i32 sys_posix_fallocate(i32, i64, i64);
...
i32 sys_inotify_init1(i32);
i32 sys_inotify_add_watch(i32, const char *, u32);
i32 sys_inotify_rm_watch(i32, i32);
...
i32 sys_renameat2(i32, const char *, i32, const char *, u32);
i32 sys_renameatx_np(i32, const char *, i32, const char *, u32);
...
i32 sys_wait6(i32, i32, i32 *, i32, void *, void *);
i32 sys_waitid(i32, i32, void *, i32, void *);
i32 __sys_socketpair(i32, i32, i32, i32[2]);
